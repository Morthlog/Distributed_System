...
public class ManagerConsoleApp {
    ...
    private Map<String, ExtendedStore> stores = new HashMap<>();
    ...
    private void loadStoresFromJson() {
        ...
        try {
            ...
            for (Object obj : storesArray) {
                ExtendedStore store = new ExtendedStore((JSONObject) obj);
    ...
    private void saveStore() {
        ...
        for (ExtendedStore s : stores.values()) {
    ...
    private void addStore() {
        ...
        try (FileReader reader = new FileReader(path)) {
            ...
            if (stores.containsKey(storeName)) {
                System.out.println("Sorry,store already exists");
                return;
            }
    ...
    private void removeProduct() {
        System.out.print("Enter the name of the store you want to remove a product: ");
        String storeName = scanner.nextLine();

        if (!stores.containsKey(storeName)) {
            System.out.print("Sorry, store not found!");
            return;
        }
    ...
    private void manageStock() {
        ...
        System.out.println("Enter the name of the product you want to manage stock: ");
        String productName = scanner.nextLine();
        System.out.println("Enter new available amount of the product: ");
    ...
    private void saveSales() {
        System.out.println("Enter the name of the store you want to save a sale: ");
        String storeName = scanner.nextLine();

        if (!stores.containsKey(storeName)) {
            System.out.println("Sorry, store not found");
            return;
        }

        System.out.println("Enter the name of the product you want to save a sale: ");
        String productName = scanner.nextLine();
    ...
    private void displaySalesByProduct() {
        ...
        if (salesByStore.isEmpty()) {
            System.out.println("Sorry, no sales found.");
        }else{
